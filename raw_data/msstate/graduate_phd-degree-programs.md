...
The Guidelines presented here are meant to be highlights. Full rules and regulations of the Graduate School can be found in the Graduate Catalog, which is available at [http://www.grad.msstate.edu](http://www.grad.msstate.edu/).
...
Students are required to have a research advisor and begin research within one year after entering the program. Before that, the graduate coordinator is the academic advisor of the student. If a student wishes to have an advisor from outside the Physics Department, the student needs permission from the Graduate Coordinator.
...
##  Comprehensive Research-based Examination   

Students must complete the CRE within 36 months of joining the departmental Ph.D/non-thesis M.S. program. You will have two attempts to pass. The CRE is overseen by the Ph.D. Advisory Committee or PAC. For more details, please check its [guidelines](https://www.physics.msstate.edu/sites/www.physics.msstate.edu/files/2025-02/Comprehensive-Research-based-Examination-final.pdf). If you have any questions concerning the examination, please email the PAC at: pac@physics.msstate.edu.​
