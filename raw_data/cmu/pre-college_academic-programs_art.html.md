[Pre-College Programs](https://www.cmu.edu/pre-college/index.html) › [ Academic Programs ](https://www.cmu.edu/pre-college/academic-programs/index.html) › Art 
# Art
### Ready to challenge how you think about art? Explore your creative ideas in a college-level studio environment.
## Program Overview
...
## Testimonials
I really enjoyed the art program! I felt pushed to work hard and made many friends from across the US. I also got to know some very interesting and knowledgeable teachers and alumni. ~ Joana L., Art 2023
Hear more from our students and families [here](https://www.cmu.edu/pre-college/admission/testimonials.html)!
## Age and Grade
Age:  
Grade:
Please read the [Eligibility and Application Requirements](https://www.cmu.edu/pre-college/academic-programs/art.html#eligibility) for complete eligibility details.
#  Application 
## Program Length
* * *
###  3 Week: 
...
The complete application for Pre-College Art consists of the following:
...
Applicants will submit responses to one essay prompt and three short answer prompts.   
...
Applicants must then answer the following short answer prompts (150-200 words each):
...
We highly recommend signing up for the 6-week program! That said, we understand that time and financial commitments are different for everyone and will ultimately dictate whether you choose the 3-week or 6-week program. We divide the program into two halves (Session One and Session Two) so that students leaving after the 3-week program feel that their coursework has been brought to a natural close.
[View Session Dates](https://www.cmu.edu/pre-college/academic-programs/art.html#programlength)
...
Classes include Drawing, Sculpture, Animation, Painting, Photography, Printmaking, and Concept Studio - a course that encourages experimentation and creative problem-solving. [](https://www.cmu.edu/pre-college/academic-programs/art.html)
[Explore Courses](https://www.cmu.edu/pre-college/academic-programs/art.html#artcourses)
...
Yes, students may live on campus in CMU residence halls with full supervision from trained residential staff. Commuter options are also available for students who live within approximately 30 miles of CMU's campus[](https://www.cmu.edu/pre-college/student-experience/housing-dining.html)
[Learn About Housing & Dining](https://www.cmu.edu/pre-college/student-experience/index.html)
...
How can this program help with college admission?
...
_All 6-week students_
  * A quality digital camera (DSLR)[DSLR camera overview](https://www.adobe.com/creativecloud/photography/discover/dslr-camera.html))
...
How is student safety supported?
...
[View Tuition & Aid Info](https://www.cmu.edu/pre-college/cost-financial-aid/index.html)
# Student Affairs
